    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_copy', models.FileField(default=0, upload_to='documents/%Y/%m/%d')),
                ...
                ('investment_copy', models.FileField(default=0, upload_to='documents/%Y/%m/%d')),
                ('banker_name', models.CharField(default=0, max_length=200)),
                ('reference_letter_copy', models.FileField(default=0, upload_to='documents/%Y/%m/%d')),
                ...
                ('business_plan_copy', models.FileField(default=0, upload_to='documents/%Y/%m/%d')),
            ],
        ),
    ]
